...
export function DebtBalanceChart({
  ...
  return (
    <div className="mt-4 h-72" role="img" aria-label={t("debt.chart.aria")} data-private-axis>
...
export function DebtSplitChart({ years, base }: { years: DebtYear[]; base: string }) {
  ...
  return (
    <div className="mt-4 h-60" role="img" aria-label={t("debt.chart.splitAria")} data-private-axis>
      <ResponsiveContainer width="100%" height="100%">
