...
//
// Planned one-off repayments (Sondertilgungen) deliberately do NOT live here:
// inside a per-liability dialog they read as a booked payment, which is what a
// transfer on the accounts page already does. They are a what-if input of the
// payoff simulation, so they sit in its plan card (`DebtRepaymentsPlanner`).
//
