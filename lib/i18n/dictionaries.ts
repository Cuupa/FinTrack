...
export const en = {
  ...
  "spending.list.payee": "Payee / payer",
  "spending.list.category": "Category",
  "spending.list.account": "Account",
  ...
  "recurring.monthEnd": "Always on the last day of the month",
  ...
  "dashboard.month.hint": "Cash in and out of your current and savings accounts, plus what your recurring entries still have to post this month.",
  ...
  "pension.total.title": "Total from your pension statement",
  "pension.total.hint": "The cumulative points your statement reports. This is your entitlement so far.",
  "pension.total.hintMax": "The cumulative points your statement reports, not one year's worth. A single year earns at most {max}.",
  "pension.total.points": "Total points",
  "pension.total.year": "As of year",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "spending.list.payee": "Empfänger / Zahler",
  "spending.list.category": "Kategorie",
  "spending.list.account": "Konto",
  ...
  "recurring.monthEnd": "Immer am letzten Tag des Monats",
  ...
  "dashboard.month.hint": "Geld, das auf deine Giro- und Sparkonten kommt und von ihnen abgeht, plus das, was deine wiederkehrenden Einträge diesen Monat noch buchen.",
  ...
  "pension.total.title": "Gesamtstand laut Renteninformation",
  "pension.total.hint": "Die Summe der Entgeltpunkte, die auf deiner Renteninformation steht. Das ist dein bisher erworbener Anspruch.",
  "pension.total.hintMax": "Die Summe der Entgeltpunkte auf deiner Renteninformation, nicht die eines einzelnen Jahres. Ein Jahr bringt höchstens {max}.",
  "pension.total.points": "Entgeltpunkte insgesamt",
  "pension.total.year": "Stand (Jahr)",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "spending.list.payee": "Beneficiario / pagador",
  "spending.list.category": "Categoría",
  "spending.list.account": "Cuenta",
  ...
  "dashboard.month.hint": "Dinero que entra y sale de tus cuentas corrientes y de ahorro, más lo que tus entradas recurrentes aún deben registrar este mes.",
  ...
  "pension.total.title": "Total según tu informe de pensión",
  "pension.total.hint": "Los puntos acumulados que indica tu informe. Es tu derecho adquirido hasta ahora.",
  "pension.total.hintMax": "Los puntos acumulados que indica tu informe, no los de un solo año. Un año da como máximo {max}.",
  "pension.total.points": "Puntos totales",
  "pension.total.year": "A fecha de (año)",
