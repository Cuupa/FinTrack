...
export const en = {
  ...
  "spending.edit.originNote": "This booking came from a contract or a planned entry. You can change its figures, but not where it came from.",
  ...
  "spending.forecast.intro":
    "What is already booked plus what is still expected, for the next {n} months. Registered contracts are included.",
  "spending.forecast.empty":
    "Nothing to forecast yet. Plan income or expenses, or register a contract.",
  ...
  "contracts.title": "Recurring",
  "contracts.subtitle": "Subscriptions, insurance and rent, with cancellation deadlines in view.",
  "contracts.suggestions.title": "Detected recurring charges",
  "contracts.suggestions.intro": "These payees charged a similar amount on a regular schedule. Add them to your register to track renewal and cancellation deadlines.",
  "contracts.suggestions.accept": "Add to register",
  "contracts.suggestions.dismiss": "Ignore",
  "contracts.form.title": "Add a contract",
  ...
  "contracts.form.add": "Add contract",
  "contracts.form.error": "Could not save the contract. Please try again.",
  "contracts.list.title": "Your contracts",
  "contracts.list.empty": "No contracts yet. Add one above, or accept a detected suggestion.",
  "contracts.list.name": "Name",
  "contracts.list.interval": "Billed",
  "contracts.list.amount": "Amount",
  "contracts.list.renewalDate": "Renewal",
  "contracts.list.delete": "Delete",
  "contracts.list.noCategory": "Uncategorized",
  "contracts.list.noticeOpen": "cancel now",
  "contracts.delete.title": "Delete contract",
  ...
  "dashboard.split.title": "What it consists of",
  "dashboard.split.invested": "Invested",
  "dashboard.split.liquid": "Liquid",
  "dashboard.split.liabilities": "Liabilities",
  "dashboard.split.total": "Net worth: {total}",
  ...
  "recurring.manageContracts": "Contract register",
  ...
  "contracts.due.bookSelected": "Book selected ({n})",
  ...
  "debt.list.editDetails": "Rate, payment & repayments",
  ...
  "debt.repayments.intro":
    "Plan lump sums you pay on top of the instalment, e.g. a bonus every June. The schedule charges each one in the month it falls due.",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "spending.edit.originNote": "Diese Buchung stammt aus einem Vertrag oder einem geplanten Eintrag. Die Zahlen kannst du ändern, die Herkunft nicht.",
  ...
  "spending.forecast.intro":
    "Was schon gebucht ist, plus was noch erwartet wird, für die nächsten {n} Monate. Erfasste Verträge sind enthalten.",
  "spending.forecast.empty":
    "Noch nichts zu prognostizieren. Plane Ein- oder Ausgaben, oder erfasse einen Vertrag.",
  ...
  "contracts.title": "Wiederkehrend",
  "contracts.subtitle": "Abos, Versicherungen und Miete, mit Kündigungsfristen im Blick.",
  "contracts.suggestions.title": "Erkannte wiederkehrende Zahlungen",
  "contracts.suggestions.intro": "Diese Zahlungsempfänger haben regelmäßig einen ähnlichen Betrag abgebucht. Füge sie zu deinem Vertragsregister hinzu, um Verlängerung und Kündigungsfrist im Blick zu behalten.",
  "contracts.suggestions.accept": "Zum Register hinzufügen",
  "contracts.suggestions.dismiss": "Ignorieren",
  "contracts.form.title": "Vertrag hinzufügen",
  "contracts.form.nameLabel": "Name",
  ...
  "contracts.form.add": "Vertrag hinzufügen",
  "contracts.form.error": "Der Vertrag konnte nicht gespeichert werden. Bitte versuche es erneut.",
  "contracts.list.title": "Deine Verträge",
  "contracts.list.empty": "Noch keine Verträge. Füge oben einen hinzu oder übernimm einen erkannten Vorschlag.",
  "contracts.list.name": "Name",
  "contracts.list.interval": "Abrechnung",
  "contracts.list.amount": "Betrag",
  "contracts.list.renewalDate": "Verlängerung",
  "contracts.list.delete": "Löschen",
  "contracts.list.noCategory": "Ohne Kategorie",
  "contracts.list.noticeOpen": "jetzt kündigen",
  "contracts.delete.title": "Vertrag löschen",
  ...
  "dashboard.split.title": "Woraus es besteht",
  "dashboard.split.invested": "Angelegt",
  "dashboard.split.liquid": "Liquide",
  "dashboard.split.liabilities": "Verbindlichkeiten",
  "dashboard.split.total": "Nettovermögen: {total}",
  ...
  "recurring.manageContracts": "Vertragsübersicht",
  ...
  "contracts.due.bookSelected": "Ausgewählte buchen ({n})",
  ...
  "contracts.edit.title": "Vertrag bearbeiten",
  ...
  "debt.list.editDetails": "Zins, Rate & Sondertilgungen",
  ...
  "debt.repayments.intro":
    "Plane Beträge, die du zusätzlich zur Rate zahlst, zum Beispiel jeden Juni deinen Bonus. Der Tilgungsplan rechnet jede in dem Monat ein, in dem sie fällig ist.",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "spending.edit.originNote": "Este movimiento procede de un contrato o de una entrada planificada. Puedes cambiar sus cifras, pero no su origen.",
  ...
  "spending.forecast.intro":
    "Lo ya registrado más lo que aún se espera, para los próximos {n} meses. Los contratos registrados se incluyen.",
  "spending.forecast.empty":
    "Todavía no hay nada que prever. Planifica ingresos o gastos, o registra un contrato.",
  ...
  "contracts.title": "Recurrente",
  "contracts.subtitle": "Suscripciones, seguros y alquiler, con los plazos de cancelación a la vista.",
  "contracts.suggestions.title": "Pagos recurrentes detectados",
  "contracts.suggestions.intro": "Estos beneficiarios cobraron un importe similar de forma regular. Añádelos a tu registro para seguir la renovación y el plazo de cancelación.",
  "contracts.suggestions.accept": "Añadir al registro",
  "contracts.suggestions.dismiss": "Ignorar",
  "contracts.form.title": "Añadir un contrato",
  ...
  "contracts.form.add": "Añadir contrato",
  "contracts.form.error": "No se pudo guardar el contrato. Inténtalo de nuevo.",
  "contracts.list.title": "Tus contratos",
  "contracts.list.empty": "Todavía no hay contratos. Añade uno arriba o acepta una sugerencia detectada.",
  "contracts.list.name": "Nombre",
  "contracts.list.interval": "Facturación",
  "contracts.list.amount": "Importe",
  "contracts.list.renewalDate": "Renovación",
  "contracts.list.delete": "Eliminar",
  "contracts.list.noCategory": "Sin categoría",
  "contracts.list.noticeOpen": "cancelar ahora",
  "contracts.delete.title": "Eliminar contrato",
  ...
  "dashboard.split.title": "De qué se compone",
  "dashboard.split.invested": "Invertido",
  "dashboard.split.liquid": "Líquido",
  "dashboard.split.liabilities": "Pasivos",
  "dashboard.split.total": "Patrimonio neto: {total}",
  ...
  "recurring.manageContracts": "Registro de contratos",
  ...
  "contracts.due.bookSelected": "Registrar seleccionados ({n})",
  ...
  "debt.list.editDetails": "Tasa, pago y amortizaciones",
  ...
  "debt.repayments.intro":
    "Planifica importes que pagas además de la cuota, por ejemplo tu bonus cada junio. El plan los aplica en el mes en que vencen.",
