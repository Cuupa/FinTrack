...
export const en = {
  ...
  "nav.accounts": "Accounts & bookings",
  ...
  "nav.account": "Account",
  "notif.pending": "{count} waiting for you",
  ...
  "sp.debitAccountNone": "No account",
  "sp.debitAccountFormHint":
    "Each execution also books the amount as an outgoing payment on this account.",
  "sp.debitAccountHint":
    "Executions with an account book a matching payment there. It counts as a transfer, not as spending.",
  ...
  "tour.areas.body":
    "This month at a glance: money in and out on the left, and how your reserve, goals and debt are progressing on the right. The home screen covers your whole financial picture, not just the portfolio.",
  ...
  "tour.accounts.totals.title": "Balances at a glance",
  "tour.accounts.totals.body":
    "Your balances, your credit balances, the change over the timeframe, and how many accounts. The chart below tracks it over time. All of it feeds your net worth.",
  ...
  "import.hint": "Export your transaction history as a CSV file from your broker or exchange.",
  "import.detected": "Detected",
  "import.unknownFormat": "Unrecognised CSV format.",
  "import.formatDisabled": "Portfolio Performance import is currently disabled.",
  ...
  "cat.group.debt": "Loans",
  "cat.debt.repayment": "Loan repayment",
  "cat.debt.interest": "Loan interest",
  ...
  "overview.status.liquid": "Liquid available",
  "overview.status.liquidTip": "Cash in your checking and savings accounts.",
  "overview.status.invested": "Invested",
  "overview.status.investedTip": "Current market value of your holdings.",
  "overview.status.liabilitiesTip": "Everything you owe across all liability accounts.",
  "overview.chart.assets": "Assets",
  "chart.netWorthBreakdown.ariaLabel":
    "Net worth breakdown, {timeframe}: assets against liabilities from {start} to {end}, net {net}.",
  "overview.plan.title": "Plan progress",
  "overview.plan.reserve": "Emergency fund",
  "overview.plan.debtPaid": "Debt repaid",
  "overview.plan.allGoals": "All goals",
  "overview.insights.title": "Key insights",
  "overview.insight.negativeSavings": "You are spending more than you earn ({rate} over budget).",
  "overview.insight.reserveLow": "Your emergency fund covers {months} of {target} months.",
  "overview.insight.highDebt": "Your debt is {multiple}x your yearly income.",
  "overview.insight.goalsReached": "You have reached {n} goal(s). Nice work.",
  "tip.depotValue": "Current market value of your positions. Accounts and liabilities are not included here.",
  "tip.change": "Net change over the timeframe\n% = time-weighted (contribution-adjusted) return",
  "tip.changeBreakdown": "Net change over the timeframe\n{parts}\n% = time-weighted return",
  ...
  "sankeyShare.full": "Share with amounts",
  "sankeyShare.fullDesc": "Includes absolute income and expenses.",
  "sankeyShare.incognito": "Share in incognito",
  "sankeyShare.incognitoDesc": "Relative flows only, no amounts.",
  "shared.viewing": "You're viewing a shared view",
  "degraded.banner": "Some areas could not be loaded ({areas}). Everything else works as usual.",
  ...
  "cashInterest.freq.QUARTERLY": "Quarterly",
  "cashInterest.freq.ANNUAL": "Yearly",
  "cashInterest.postDayLabel": "Posts on",
  "cashInterest.postDay.first": "First day of month",
  "cashInterest.postDay.last": "Last day of month",
  "cashInterest.save": "Save",
  "cashInterest.saved": "Saved",
  "cashInterest.disable": "Set the rate to 0 to turn interest off.",
  "cashInterest.next": "Next credit on {date}.",
  "cashInterest.due": "{count} interest credit(s) due, {total} total.",
  ...
  "accounts.title": "Accounts & bookings",
  "accounts.subtitle": "Cash, savings, debt, and every booking against them.",
  ...
  "accounts.tab.accounts": "Accounts",
  "accounts.tab.bookings": "Bookings",
  "accounts.tab.recurring": "Recurring",
  "accounts.group.payments": "Payments",
  "accounts.group.reserves": "Reserves",
  "accounts.group.other": "Other",
  "accounts.group.credit": "Credit",
  "accounts.summary.balance": "Balance",
  "accounts.summary.creditBalances": "Credit balances",
  "accounts.summary.count": "Accounts",
  "accounts.chart.title": "History",
  "accounts.hero.allScope": "Net across all accounts",
  "accounts.hero.someScope": "Net across the selected accounts",
  "accounts.hero.oneScope": "Balance",
  "accounts.hero.pick": "Which accounts to show",
  "accounts.hero.change": "Change ({timeframe})",
  "accounts.hero.count": "Accounts",
  "accounts.hero.noChart": "Not enough history yet to draw a curve.",
  "accounts.hero.chartAria": "Balance of {scope} from {start} to {end}, change {change}.",
  ...
  "accounts.form.namePlaceholder": "e.g. Checking account",
  "accounts.form.kindLabel": "Type",
  "accounts.form.currencyLabel": "Currency",
  "accounts.form.openingLabel": "Opening balance ({currency})",
  "accounts.form.openedLabel": "As of",
  ...
  "spending.subtitle": "Expense and income transactions against your accounts.",
  ...
  "spending.form.type.income": "Income",
  "spending.form.amountLabel": "Amount ({currency})",
  "spending.form.payeeLabel": "Payee",
  "spending.form.payeePlaceholder": "e.g. Rewe",
  "spending.form.payerLabel": "Payer",
  "spending.form.payerPlaceholder": "e.g. employer",
  "spending.form.categoryLabel": "Category",
  "spending.form.categoryNone": "Uncategorised",
  "spending.form.dateLabel": "Date",
  "spending.form.timeLabel": "Time",
  "spending.form.noteLabel": "Note",
  "spending.form.notePlaceholder": "Optional",
  ...
  "spending.list.payer": "Payer",
  "spending.list.category": "Category",
  "spending.list.amount": "Amount",
  "spending.list.delete": "Delete",
  ...
  "spending.edit.transferHintOff": "Counts as an ordinary expense or income.",
  "spending.list.uncategorized": "Uncategorised",
  "spending.delete.title": "Delete transaction",
  ...
  "spending.categories.newCategory": "+ New category",
  "spending.categories.newGroup": "+ New group",
  "spending.categories.add": "Add",
  "spending.categories.delete": "Delete",
  ...
  "spending.budgets.noCategoriesTitle": "No categories yet",
  ...
  "spending.budgets.emptyTitle": "No budgets yet",
  "spending.budgets.emptyCta": "Create your first budget",
  "spending.budgets.categoryLabel": "Category",
  "spending.budgets.amountLabel": "Monthly cap ({currency})",
  "spending.budgets.add": "Add budget",
  "spending.budgets.error": "The budget could not be saved. Please try again.",
  "spending.budgets.overBudget": "{amount} over budget",
  "spending.budgets.delete": "Delete budget",
  "spending.budgets.deleteConfirm": "Delete the budget for \"{name}\"?",
  ...
  "spending.planned.typeLabel": "Type",
  "spending.planned.type.income": "Income",
  "spending.planned.type.expense": "Expense",
  "spending.planned.amountLabel": "Amount ({currency})",
  "spending.planned.categoryLabel": "Category",
  "spending.planned.categoryNone": "No category",
  "spending.planned.intervalLabel": "Interval",
  "spending.planned.interval.ONCE": "One-off",
  "spending.planned.interval.WEEKLY": "Weekly",
  "spending.planned.interval.MONTHLY": "Monthly",
  "spending.planned.interval.QUARTERLY": "Quarterly",
  "spending.planned.interval.ANNUAL": "Yearly",
  "spending.planned.startLabel": "First date",
  "spending.planned.endLabel": "Last date (optional)",
  "spending.planned.transferLabel": "Transfer to (optional)",
  "spending.planned.transferNone": "Not a transfer",
  "spending.planned.transferHint":
    "Money moved between your own accounts counts as neither income nor expense.",
  "spending.planned.noteLabel": "Note",
  "spending.planned.notePlaceholder": "Optional",
  "spending.planned.add": "Add planned entry",
  "spending.planned.save": "Save",
  "spending.planned.cancel": "Cancel",
  "spending.planned.edit": "Edit",
  "spending.planned.editTitle": "Edit planned entry",
  "spending.planned.delete": "Delete",
  "spending.planned.deleteTitle": "Delete planned entry",
  "spending.planned.deleteConfirm":
    "Delete \"{name}\"? Bookings already in the ledger stay untouched.",
  "spending.planned.error": "The planned entry could not be saved. Please try again.",
  "spending.planned.col.name": "Description",
  "spending.planned.col.account": "Account",
  "spending.planned.col.category": "Category",
  "spending.planned.col.interval": "Interval",
  "spending.planned.col.next": "Next date",
  "spending.planned.col.amount": "Amount",
  "spending.planned.col.monthly": "Per month",
  "spending.planned.finished": "Finished",
  "spending.planned.due.button": "Book {n} due payment(s)",
  "spending.planned.due.title": "Due bookings",
  "spending.planned.due.intro":
    "{n} planned payment(s) are due. Check the amounts, they are often not exactly as planned.",
  "spending.planned.due.date": "Date",
  "spending.planned.due.name": "Description",
  "spending.planned.due.account": "Account",
  "spending.planned.due.amount": "Amount",
  "spending.planned.due.book": "Book now",
  ...
  "spending.forecast.plannedIncome": "Planned income",
  "spending.forecast.plannedExpense": "Planned expenses",
  "spending.forecast.cumulative": "Cumulative",
  "spending.forecast.monthlyIncome": "Planned income per month",
  "spending.forecast.monthlyExpense": "Planned expenses per month",
  ...
  "contracts.form.namePlaceholder": "e.g. Netflix",
  "contracts.form.amountLabel": "Amount ({currency})",
  "contracts.form.intervalLabel": "Billed",
  "contracts.form.categoryLabel": "Category",
  "contracts.form.renewalLabel": "Renewal date",
  "contracts.form.noticeLabel": "Cancellation notice (days)",
  "contracts.form.add": "Add",
  "contracts.form.error": "Could not save the recurring payment. Please try again.",
  "contracts.list.delete": "Delete",
  "contracts.list.noCategory": "Uncategorized",
  "contracts.delete.title": "Delete recurring payment",
  "contracts.delete.message": "Delete \"{name}\"? This cannot be undone.",
  "contracts.interval.MONTHLY": "Monthly",
  "contracts.interval.QUARTERLY": "Quarterly",
  "contracts.interval.ANNUAL": "Annually",
  "cashflow.title": "Cash flow",
  "cashflow.subtitle": "Where the money goes, and whether it adds up.",
  "cashflow.tab.overview": "Overview",
  "cashflow.tab.budgets": "Budgets",
  "cashflow.tab.forecast": "Forecast",
  "cashflow.flow.title": "Money flow",
  "cashflow.view.bars": "Bars",
  ...
  "recurring.col.interval": "Rhythm",
  "recurring.col.target": "Goes to",
  "recurring.monthEnd": "Last day of the month",
  "recurring.interestName": "Interest · {name}",
  "recurring.interestAuto": "Booked automatically",
  "recurring.due.autoBooked": "{n} interest booking(s) posted automatically",
  "recurring.target.consumed": "Spent",
  "recurring.target.credited": "Credited",
  "recurring.col.next": "Next",
  "recurring.due.banner": "{n} booking(s) due",
  ...
  "recurring.interval.WEEKLY": "Weekly",
  "recurring.interval.MONTHLY": "Monthly",
  "recurring.interval.QUARTERLY": "Quarterly",
  "recurring.interval.ANNUAL": "Annually",
  "portfolio.title": "Portfolio",
  "portfolio.subtitle": "Your positions, savings plans and watchlist.",
  "portfolio.tab.positions": "Positions",
  "portfolio.tab.savings": "Savings plans",
  "portfolio.tab.watchlist": "Watchlist",
  "portfolio.tab.history": "History",
  "dashboard.month.title": "This month",
  "dashboard.month.in": "Income",
  "dashboard.month.out": "Expenses",
  "dashboard.month.open": "Outstanding",
  "dashboard.month.hint": "",
  "spending.form.recurring": "Recurring",
  "spending.form.recurringHint": "Repeats automatically from the start date",
  "table.page.range": "{from}\u2013{to} of {total}",
  "table.page.of": "Page {page} of {pages}",
  "table.page.prev": "Back",
  "table.page.next": "Next",
  "spending.form.addRecurring": "Add recurring entry",
  "recurring.detail.subtitle": "Everything this entry has booked.",
  "recurring.detail.bookings": "Bookings",
  "recurring.detail.noBookings": "Nothing booked yet.",
  "recurring.detail.bookedTotal": "Booked so far",
  ...
  "contracts.form.kindContract": "Payment",
  ...
  "spending.list.makeContractTitle": "Add this booking as a recurring entry?",
  "spending.list.makeContractMsg": "Creates a monthly recurring entry for {payee} from this booking. You can change the rhythm and everything else on its own page.",
  ...
  "contracts.edit.title": "Edit recurring payment",
  "contracts.edit.save": "Save",
  ...
  "contracts.insuranceType.household": "Household contents",
  "contracts.insuranceType.legal": "Legal protection",
  "contracts.insuranceType.disability": "Disability / income protection",
  "contracts.insuranceType.life": "Life",
  ...
  "goals.form.emptyHint": "Set a target amount and track your progress toward it.",
  ...
  "goals.form.groupDepots": "Depots",
  "goals.form.groupPositions": "Positions",
  "goals.form.groupAccounts": "Accounts",
  ...
  "goals.list.current": "Saved",
  "goals.list.status": "Status",
  "goals.status.reached": "Reached",
  "goals.status.onTrack": "On track",
  "goals.status.overdue": "Overdue",
  "goals.summary.count": "Goals",
  "goals.summary.target": "Total target",
  "goals.summary.saved": "Saved",
  "goals.summary.progress": "Overall progress",
  ...
  "health.gauge.monthsOfExpenses.hint": "Aim for 3-6 months of expenses in liquid savings.",
  "health.gauge.savingsRate.label": "Savings rate",
  "health.gauge.savingsRate.hint": "Share of income kept after expenses, aim for 20% or more.",
  "health.gauge.debtToIncome.label": "Debt to income",
  "health.gauge.debtToIncome.hint": "Total liabilities against a year of income, lower is better.",
  "health.gauge.netWorthToIncome.label": "Net worth to income",
  "health.gauge.netWorthToIncome.hint": "Net worth as a multiple of a year of income.",
  ...
  "pension.stat.statutory": "Statutory pension / month",
  "pension.stat.private": "Private policies / month",
  "pension.stat.total": "Total / month",
  "pension.stat.earned": "Earned so far / month",
  "pension.stat.retirementYear": "Retirement year",
  "pension.stat.accessFactor": "Access factor",
  "pension.stat.level": "Pension level",
  "pension.assumptions.title": "Assumptions",
  "pension.assumptions.hint": "Leave a field empty to use the default: your standard retirement age, and the average points of your last five recorded years.",
  ...
  "pension.statements.add": "Add statement",
  "pension.statements.empty": "No statements yet.",
  "pension.statements.invalid": "Enter a year and a total.",
  ...
  "pension.points.add": "Add year",
  "pension.points.empty": "No years entered yet.",
  "pension.points.invalid": "Enter a year and a number of points.",
  ...
  "pension.contracts.note": "Note",
  "pension.contracts.add": "Add policy",
  "pension.contracts.edit": "Edit policy",
  "pension.contracts.empty": "No policies recorded yet.",
  "pension.contracts.deleteTitle": "Delete policy?",
  "pension.contracts.deleteMessage": "“{name}” will be removed.",
  "pension.kind.private": "Private pension",
  "pension.kind.riester": "Riester",
  "pension.kind.ruerup": "Ruerup (Basisrente)",
  "pension.kind.occupational": "Company pension",
  "pension.kind.statutory_other": "Other statutory scheme",
  "pension.kind.other": "Other",
  "tour.pension.summary.title": "Your retirement income",
  "tour.pension.summary.body": "What your pension points and policies add up to per month, in today's money.",
  ...
  "debt.totals.repaidOf": "{repaid} of {original} repaid ({pct}%)",
  "debt.list.interest": "Interest",
  ...
  "debt.details.intro": "Nominal rate, not APR: the schedule charges one twelfth per month.",
  ...
  "debt.repayments.intro": "Add lump sums to simulate. Not saved.",
  "debt.repayments.accountLabel": "Liability",
  "debt.repayments.dateLabel": "Date",
  "debt.repayments.amountLabel": "Amount ({currency})",
  "debt.repayments.add": "Add repayment",
  "debt.repayments.remove": "Remove repayment",
  "debt.repayments.empty": "No one-off repayments planned yet.",
  "debt.details.error": "Could not save. Please try again.",
  "debt.plan.title": "Payoff plan",
  "debt.plan.intro": "Every debt on its minimum, plus extra on one at a time.",
  "debt.plan.strategyLabel": "Strategy",
  "debt.plan.strategy.avalanche": "Avalanche (highest rate first)",
  "debt.plan.strategy.snowball": "Snowball (smallest balance first)",
  "debt.plan.extraLabel": "Extra monthly payment ({currency})",
  ...
  "debt.chart.horizon.all": "Total",
  "debt.chart.horizon.5y": "5 years",
  "debt.chart.horizon.10y": "10 years",
  "addAsset.otherValue": "Current value ({currency})",

  // Analysis
  "analysis.tab.distributions": "Distributions",
  "analysis.tab.xray": "X-Ray",
  ...
  "household.subtitle": "Share your accounts with a partner or family member.",
  ...
  "household.leaveConfirm": "Leave this household? You will lose access to shared accounts.",
  "household.inviteTitle": "Invite a member",
  "household.emailPlaceholder": "Email address",
  "household.invite": "Invite",
  "household.revoke": "Revoke",
  "household.invitesReceived": "Invitations",
  ...
  "rebalance.deviation": "Current vs target",
  ...
  "sim.medianWealth": "Projected final wealth (median)",
  ...
  "sim.runsLabel": "runs",
  "sim.contributed": "Contributed capital",
  "sim.growth": "Value gain (median)",
  ...
  "admin.usage.new": "New (30d)",
  "admin.usage.errors": "Errors (24h)",
  ...
  "admin.usage.opsTitle": "Operations (30 days)",
  "admin.usage.shares": "Portfolios shared",
  "admin.usage.imports": "CSV rows imported",
  "admin.usage.feature.assets": "Holdings",
  "admin.usage.feature.transactions": "Transactions",
  "admin.usage.feature.watchlist": "Watchlist",
  "admin.usage.feature.savingsPlans": "Savings plans",
  "admin.usage.feature.tags": "Tags",
  "admin.usage.feature.accounts": "Accounts & liabilities",
  "admin.usage.feature.accountBalances": "Balance readings",
  "admin.usage.feature.spending": "Income & spending",
  "admin.usage.feature.spendingCategories": "Spending categories",
  "admin.usage.feature.recurring": "Recurring payments",
  "admin.usage.feature.plannedCashflow": "Planned cash flow",
  "admin.usage.feature.goals": "Goals",
  "admin.usage.feature.pensionPoints": "Pension points",
  "admin.usage.feature.pensionContracts": "Pension policies",
  "admin.usage.feature.llm": "Assistant (own key)",
  "admin.usage.feature.push": "Push notifications",
  "admin.usage.feature.imports": "CSV import",
  "admin.usage.feature.sharing": "Shared portfolios",
  "admin.usage.feature.proGrants": "Pro grants",
  ...
  "admin.billing.keysTitle": "Stripe keys",
  "admin.billing.keysSubtitle":
    "A stored key wins over the STRIPE_SECRET_KEY / STRIPE_WEBHOOK_SECRET environment variables. Leave a field empty to keep its current value.",
  "admin.billing.secretKeyLabel": "Secret key",
  "admin.billing.secretKeyPlaceholder": "sk_live_...",
  "admin.billing.webhookSecretLabel": "Webhook secret",
  "admin.billing.webhookSecretPlaceholder": "whsec_...",
  "admin.billing.statusSet": "Configured",
  "admin.billing.statusNotSet": "Not configured",
  ...
  "admin.billing.grantSearchNoResults": "No users match that email.",
  "admin.billing.grantChosen": "Chosen: {email}",
  "admin.billing.grantEndDateLabel": "End date (optional)",
  "admin.billing.grantNoteLabel": "Note (optional)",
  "admin.billing.grantNotePlaceholder": "e.g. thank you for the bug report",
  "admin.billing.grantButton": "Grant Pro",
  "admin.billing.grantsColEmail": "Email",
  "admin.billing.grantsColEndDate": "End date",
  "admin.billing.grantsColNote": "Note",
  "admin.billing.grantsColCreated": "Created",
  "admin.billing.grantsUnlimited": "Unlimited",
  "admin.billing.grantsEmpty": "No grants yet.",
  "admin.billing.revoke": "Revoke",
  "admin.billing.revokeConfirmTitle": "Revoke this grant?",
  "admin.billing.revokeConfirmMsg": 'Revoke Pro access granted to "{email}"?',
  ...
  "admin.errors.levelAll": "All levels",
  "admin.errors.levelDebug": "Debug",
  "admin.errors.levelInfo": "Info",
  "admin.errors.levelWarn": "Warning",
  "admin.errors.levelError": "Error",
  "admin.errors.levelFatal": "Fatal",
  ...
  "admin.errors.kindConsoleHelp": "Something written to the browser console as an error or warning",
  "admin.errors.kindServer": "Server",
  "admin.errors.kindServerHelp": "An API route or page failed on the server",
  "admin.errors.count": "Showing {count} of {total} loaded rows",
  "admin.errors.colLevel": "Level",
  ...
  "settings.billing.granted": "Premium granted",
  "settings.billing.grantedUntil": "Premium granted until {date}",
  ...
  "pricing.pro.feature2": "Yearly tax report",
  "pricing.pro.feature3": "Dividend dashboard and forecast",
  "pricing.pro.feature4": "Monte Carlo simulation",
  "pricing.pro.feature5": "ETF x-ray look-through",
  "pricing.pro.feature6": "Rebalancing",
  "pricing.pro.perMonth": "{price} / month",
  "pricing.pro.perYear": "{price} / year",
  "pricing.pro.pricesPending": "Prices coming soon",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "sp.debitAccountNone": "Kein Konto",
  "sp.debitAccountFormHint":
    "Jede Ausführung bucht den Betrag zusätzlich als Abgang auf diesem Konto.",
  "sp.debitAccountHint":
    "Ausführungen mit Konto buchen dort eine passende Abbuchung. Sie zählt als Umbuchung, nicht als Ausgabe.",
  ...
  "tour.areas.body":
    "Der Monat auf einen Blick: links rein und raus, rechts der Fortschritt bei Notgroschen, Zielen und Schulden. Die Startseite zeigt dein ganzes Finanzbild, nicht nur das Depot.",
  ...
  // Round-24 page tours: one per primary surface (lib/onboarding/tour-steps.ts).
  "tour.accounts.totals.title": "Salden auf einen Blick",
  "tour.accounts.totals.body":
    "Deine Guthaben, deine Kreditsalden, die Veränderung im Zeitraum und die Kontenzahl. Der Chart darunter zeigt den Verlauf. Alles davon fließt ins Nettovermögen.",
  ...
  "import.hint": "Exportiere deine Transaktionshistorie als CSV-Datei bei deinem Broker oder deiner Börse.",
  "import.detected": "Erkannt",
  "import.unknownFormat": "Unbekanntes CSV-Format.",
  "import.formatDisabled": "Der Portfolio-Performance-Import ist derzeit deaktiviert.",
  ...
  "cat.group.debt": "Kredit",
  "cat.debt.repayment": "Kredittilgung",
  "cat.debt.interest": "Kreditzinsen",
  ...
  "overview.status.liquid": "Liquid verfügbar",
  "overview.status.liquidTip": "Guthaben auf deinen Giro- und Sparkonten.",
  "overview.status.invested": "Investiert",
  "overview.status.investedTip": "Aktueller Marktwert deiner Positionen.",
  "overview.status.liabilitiesTip": "Alles, was du über deine Verbindlichkeitskonten schuldest.",
  "overview.chart.assets": "Vermögen",
  "overview.plan.title": "Planfortschritt",
  "overview.plan.reserve": "Notgroschen",
  "overview.plan.debtPaid": "Schulden getilgt",
  "overview.plan.allGoals": "Alle Ziele",
  "overview.insights.title": "Wichtige Hinweise",
  "overview.insight.negativeSavings": "Du gibst mehr aus als du einnimmst ({rate} über Budget).",
  "overview.insight.reserveLow": "Dein Notgroschen deckt {months} von {target} Monaten.",
  "overview.insight.highDebt": "Deine Schulden betragen das {multiple}-fache deines Jahreseinkommens.",
  "overview.insight.goalsReached": "Du hast {n} Ziel(e) erreicht. Stark.",
  "chart.netWorthBreakdown.ariaLabel":
    "Nettovermögen-Aufschlüsselung, {timeframe}: Vermögen gegen Verbindlichkeiten von {start} bis {end}, netto {net}.",
  "tip.depotValue": "Aktueller Marktwert deiner Positionen. Konten und Verbindlichkeiten sind hier nicht enthalten.",
  "tip.change": "Netto-Veränderung im Zeitraum\n% = zeitgewichtete (einzahlungsbereinigte) Rendite",
  "tip.changeBreakdown": "Netto-Veränderung im Zeitraum\n{parts}\n% = zeitgewichtete Rendite",
  ...
  "sankeyShare.full": "Mit Beträgen teilen",
  "sankeyShare.fullDesc": "Enthält absolute Einnahmen und Ausgaben.",
  "sankeyShare.incognito": "Inkognito teilen",
  "sankeyShare.incognitoDesc": "Nur relative Flüsse, keine Beträge.",
  "shared.viewing": "Du siehst eine geteilte Ansicht",
  "degraded.banner": "Einige Bereiche konnten nicht geladen werden ({areas}). Der Rest funktioniert normal.",
  ...
  "cashInterest.freq.QUARTERLY": "Vierteljährlich",
  "cashInterest.freq.ANNUAL": "Jährlich",
  "cashInterest.postDayLabel": "Gutschrift am",
  "cashInterest.postDay.first": "Erster Tag des Monats",
  "cashInterest.postDay.last": "Letzter Tag des Monats",
  "cashInterest.save": "Speichern",
  "cashInterest.saved": "Gespeichert",
  "cashInterest.disable": "Setze den Satz auf 0, um die Verzinsung auszuschalten.",
  "cashInterest.next": "Nächste Gutschrift am {date}.",
  "cashInterest.due": "{count} Zinsgutschrift(en) fällig, {total} gesamt.",
  ...
  "accounts.title": "Konten & Buchungen",
  "accounts.subtitle": "Bargeld, Ersparnisse, Schulden und jede Buchung darauf.",
  ...
  "accounts.tab.accounts": "Konten",
  "accounts.tab.bookings": "Buchungen",
  "accounts.tab.recurring": "Wiederkehrend",
  "accounts.group.payments": "Zahlungsverkehr",
  "accounts.group.reserves": "Rücklagen",
  "accounts.group.other": "Sonstiges",
  "accounts.group.credit": "Kredite",
  "accounts.summary.balance": "Guthaben",
  "accounts.summary.creditBalances": "Kreditsalden",
  "accounts.summary.count": "Konten",
  "accounts.chart.title": "Verlauf",
  "accounts.hero.allScope": "Netto über alle Konten",
  "accounts.hero.someScope": "Netto über die ausgewählten Konten",
  "accounts.hero.oneScope": "Saldo",
  "accounts.hero.pick": "Welche Konten angezeigt werden",
  "accounts.hero.change": "Veränderung ({timeframe})",
  "accounts.hero.count": "Konten",
  "accounts.hero.noChart": "Noch zu wenig Verlauf für eine Kurve.",
  "accounts.hero.chartAria": "Saldo von {scope} vom {start} bis {end}, Veränderung {change}.",
  ...
  "accounts.form.nameLabel": "Name",
  "accounts.form.namePlaceholder": "z. B. Girokonto",
  "accounts.form.kindLabel": "Typ",
  "accounts.form.currencyLabel": "Währung",
  "accounts.form.openingLabel": "Startsaldo ({currency})",
  "accounts.form.openedLabel": "Stand",
  ...
  "accounts.kind.checking": "Girokonto",
  "accounts.kind.savings": "Sparkonto",
  "accounts.kind.credit": "Kreditkarte",
  "accounts.kind.loan": "Kredit",
  ...
  "spending.subtitle": "Ausgaben- und Einnahmenbuchungen auf deinen Konten.",
  "spending.totals.income": "Einnahmen",
  "spending.totals.expense": "Ausgaben",
  "spending.totals.net": "Netto",
  "spending.form.title": "Buchung hinzufügen",
  "spending.form.noAccounts": "Du brauchst zuerst ein Konto, um Ausgaben zu erfassen. Lege eins auf der Konten-Seite an.",
  "spending.form.accountLabel": "Konto",
  "spending.form.typeLabel": "Art",
  "spending.form.type.expense": "Ausgabe",
  "spending.form.type.income": "Einnahme",
  "spending.form.amountLabel": "Betrag ({currency})",
  "spending.form.payeeLabel": "Empfänger",
  "spending.form.payeePlaceholder": "z. B. Rewe",
  "spending.form.payerLabel": "Zahler",
  "spending.form.payerPlaceholder": "z. B. Arbeitgeber",
  "spending.form.categoryLabel": "Kategorie",
  "spending.form.categoryNone": "Ohne Kategorie",
  "spending.form.dateLabel": "Datum",
  "spending.form.timeLabel": "Uhrzeit",
  "spending.form.noteLabel": "Notiz",
  "spending.form.notePlaceholder": "Optional",
  ...
  "spending.list.payer": "Zahler",
  "spending.list.category": "Kategorie",
  "spending.list.amount": "Betrag",
  "spending.list.delete": "Löschen",
  "spending.list.edit": "Bearbeiten",
  "spending.edit.title": "Buchung bearbeiten",
  "spending.edit.save": "Speichern",
  "spending.edit.originNote": "Diese Buchung stammt aus einer wiederkehrenden oder geplanten Zahlung. Die Zahlen kannst du ändern, die Herkunft nicht.",
  "spending.edit.transferLabel": "Umbuchung auf",
  "spending.edit.transferHintOn": "Zählt als Umbuchung: bewegt das andere Konto und bleibt aus Ein- und Ausgaben heraus.",
  "spending.edit.transferNone": "Keine Umbuchung",
  "spending.edit.transferHintOff": "Zählt als normale Ausgabe oder Einnahme.",
  "spending.list.uncategorized": "Ohne Kategorie",
  "spending.delete.title": "Buchung löschen",
  ...
  "spending.categories.newCategory": "+ Neue Kategorie",
  "spending.categories.newGroup": "+ Neue Gruppe",
  "spending.categories.add": "Hinzufügen",
  "spending.categories.delete": "Löschen",
  ...
  "spending.budgets.title": "Budgets",
  "spending.budgets.noCategoriesTitle": "Noch keine Kategorien",
  ...
  "spending.budgets.emptyTitle": "Noch keine Budgets",
  "spending.budgets.emptyCta": "Erstes Budget anlegen",
  ...
  "spending.budgets.error": "Das Budget konnte nicht gespeichert werden. Bitte versuche es erneut.",
  "spending.budgets.overBudget": "{amount} über dem Budget",
  "spending.budgets.delete": "Budget löschen",
  "spending.budgets.deleteConfirm": "Das Budget für \"{name}\" löschen?",
  ...
  "spending.planned.typeLabel": "Art",
  "spending.planned.type.income": "Einnahme",
  "spending.planned.type.expense": "Ausgabe",
  "spending.planned.amountLabel": "Betrag ({currency})",
  "spending.planned.categoryLabel": "Kategorie",
  "spending.planned.categoryNone": "Keine Kategorie",
  "spending.planned.intervalLabel": "Intervall",
  "spending.planned.interval.ONCE": "Einmalig",
  "spending.planned.interval.WEEKLY": "Wöchentlich",
  "spending.planned.interval.MONTHLY": "Monatlich",
  "spending.planned.interval.QUARTERLY": "Vierteljährlich",
  "spending.planned.interval.ANNUAL": "Jährlich",
  "spending.planned.startLabel": "Erster Termin",
  "spending.planned.endLabel": "Letzter Termin (optional)",
  "spending.planned.transferLabel": "Umbuchung auf (optional)",
  "spending.planned.transferNone": "Keine Umbuchung",
  "spending.planned.transferHint":
    "Geld zwischen deinen eigenen Konten zählt weder als Einnahme noch als Ausgabe.",
  "spending.planned.noteLabel": "Notiz",
  "spending.planned.notePlaceholder": "Optional",
  "spending.planned.add": "Geplanten Posten hinzufügen",
  "spending.planned.save": "Speichern",
  "spending.planned.cancel": "Abbrechen",
  "spending.planned.edit": "Bearbeiten",
  "spending.planned.editTitle": "Geplanten Posten bearbeiten",
  "spending.planned.delete": "Löschen",
  "spending.planned.deleteTitle": "Geplanten Posten löschen",
  "spending.planned.deleteConfirm":
    "\"{name}\" löschen? Bereits gebuchte Zahlungen bleiben im Buch stehen.",
  "spending.planned.error":
    "Der geplante Posten konnte nicht gespeichert werden. Bitte versuche es erneut.",
  "spending.planned.col.name": "Bezeichnung",
  "spending.planned.col.account": "Konto",
  "spending.planned.col.category": "Kategorie",
  "spending.planned.col.interval": "Intervall",
  "spending.planned.col.next": "Nächster Termin",
  "spending.planned.col.amount": "Betrag",
  "spending.planned.col.monthly": "Pro Monat",
  "spending.planned.finished": "Abgeschlossen",
  "spending.planned.due.button": "{n} fällige Zahlung(en) buchen",
  "spending.planned.due.title": "Fällige Buchungen",
  "spending.planned.due.intro":
    "{n} geplante Zahlung(en) sind fällig. Prüf die Beträge, sie fallen selten genau wie geplant aus.",
  "spending.planned.due.date": "Datum",
  "spending.planned.due.name": "Bezeichnung",
  "spending.planned.due.account": "Konto",
  "spending.planned.due.amount": "Betrag",
  "spending.planned.due.book": "Jetzt buchen",
  ...
  "spending.forecast.plannedIncome": "Geplante Einnahmen",
  "spending.forecast.plannedExpense": "Geplante Ausgaben",
  "spending.forecast.cumulative": "Kumuliert",
  "spending.forecast.monthlyIncome": "Geplante Einnahmen pro Monat",
  "spending.forecast.monthlyExpense": "Geplante Ausgaben pro Monat",
  ...
  "contracts.form.nameLabel": "Name",
  "contracts.form.namePlaceholder": "z.B. Netflix",
  "contracts.form.amountLabel": "Betrag ({currency})",
  "contracts.form.intervalLabel": "Abrechnung",
  "contracts.form.categoryLabel": "Kategorie",
  "contracts.form.renewalLabel": "Verlängerungsdatum",
  "contracts.form.noticeLabel": "Kündigungsfrist (Tage)",
  "contracts.form.add": "Hinzufügen",
  "contracts.form.error": "Die wiederkehrende Zahlung konnte nicht gespeichert werden. Bitte versuche es erneut.",
  "contracts.list.delete": "Löschen",
  "contracts.list.noCategory": "Ohne Kategorie",
  "contracts.delete.title": "Wiederkehrende Zahlung löschen",
  "contracts.delete.message": "\"{name}\" löschen? Das kann nicht rückgängig gemacht werden.",
  "contracts.interval.MONTHLY": "Monatlich",
  "contracts.interval.QUARTERLY": "Vierteljährlich",
  "contracts.interval.ANNUAL": "Jährlich",
  "cashflow.title": "Cashflow",
  "cashflow.subtitle": "Wohin das Geld geht und ob es aufgeht.",
  "cashflow.tab.overview": "Übersicht",
  "cashflow.tab.budgets": "Budgets",
  "cashflow.tab.forecast": "Prognose",
  "cashflow.flow.title": "Geldfluss",
  "cashflow.view.bars": "Balken",
  "cashflow.view.flow": "Geldfluss",
  ...
  "recurring.col.interval": "Rhythmus",
  "recurring.col.target": "Ziel",
  "recurring.monthEnd": "Letzter Tag des Monats",
  "recurring.interestName": "Zinsen · {name}",
  "recurring.interestAuto": "Wird automatisch gebucht",
  "recurring.due.autoBooked": "{n} Zinsbuchung(en) automatisch gebucht",
  "recurring.target.consumed": "Verbraucht",
  "recurring.target.credited": "Gutschrift",
  "recurring.col.next": "Nächste",
  "recurring.due.banner": "{n} Buchung(en) fällig",
  ...
  "recurring.interval.WEEKLY": "Wöchentlich",
  "recurring.interval.MONTHLY": "Monatlich",
  "recurring.interval.QUARTERLY": "Vierteljährlich",
  "recurring.interval.ANNUAL": "Jährlich",
  "portfolio.title": "Depot",
  "portfolio.subtitle": "Deine Positionen, Sparpläne und Watchlist.",
  "portfolio.tab.positions": "Positionen",
  "portfolio.tab.savings": "Sparpläne",
  "portfolio.tab.watchlist": "Watchlist",
  "portfolio.tab.history": "Historie",
  "dashboard.month.title": "Dieser Monat",
  "dashboard.month.in": "Einnahmen",
  "dashboard.month.out": "Ausgaben",
  "dashboard.month.open": "Noch ausstehend",
  "dashboard.month.hint": "",
  "spending.form.recurring": "Wiederkehrend",
  "spending.form.recurringHint": "Wiederholt sich automatisch ab dem Startdatum",
  "table.page.range": "{from}\u2013{to} von {total}",
  "table.page.of": "Seite {page} von {pages}",
  "table.page.prev": "Zur\u00fcck",
  "table.page.next": "Weiter",
  "spending.form.addRecurring": "Wiederkehrend anlegen",
  "recurring.detail.subtitle": "Alles, was dieser Eintrag gebucht hat.",
  "recurring.detail.bookings": "Buchungen",
  "recurring.detail.noBookings": "Noch nichts gebucht.",
  "recurring.detail.bookedTotal": "Bisher gebucht",
  ...
  "contracts.form.kindContract": "Zahlung",
  ...
  "spending.list.makeContractTitle": "Diese Buchung als wiederkehrenden Eintrag anlegen?",
  "spending.list.makeContractMsg": "Legt aus dieser Buchung einen monatlichen wiederkehrenden Eintrag für {payee} an. Rhythmus und alles Weitere kannst du auf seiner eigenen Seite ändern.",
  ...
  "contracts.edit.title": "Wiederkehrende Zahlung bearbeiten",
  "contracts.edit.save": "Speichern",
  ...
  "contracts.insuranceType.household": "Hausrat",
  "contracts.insuranceType.legal": "Rechtsschutz",
  "contracts.insuranceType.disability": "Berufsunfähigkeit / Einkommensschutz",
  "contracts.insuranceType.life": "Lebensversicherung",
  ...
  "goals.form.emptyHint": "Leg einen Zielbetrag fest und verfolge deinen Fortschritt dorthin.",
  "goals.form.nameLabel": "Name",
  ...
  "goals.form.groupDepots": "Depots",
  "goals.form.groupPositions": "Positionen",
  "goals.form.groupAccounts": "Konten",
  ...
  "goals.list.current": "Gespart",
  "goals.list.status": "Status",
  "goals.status.reached": "Erreicht",
  "goals.status.onTrack": "Im Plan",
  "goals.status.overdue": "In Verzug",
  "goals.summary.count": "Ziele",
  "goals.summary.target": "Zielsumme",
  "goals.summary.saved": "Gespart",
  "goals.summary.progress": "Gesamtfortschritt",
  ...
  "health.gauge.netWorthToIncome.hint": "Nettovermögen als Vielfaches eines Jahreseinkommens.",
  ...
  "pension.title": "Rente",
  "pension.subtitle": "Deine Rentenpunkte und privaten Vorsorgeverträge, hochgerechnet auf eine monatliche Rente.",
  "pension.todaysMoney": "Alle Werte in heutigem Geld: ohne Inflation, ohne Lohnsteigerung und ohne angenommene Rendite. So kannst du sie direkt mit deinen heutigen Ausgaben vergleichen.",
  "pension.saveFailed": "Konnte nicht gespeichert werden.",
  "pension.gap": "Dir fehlen {amount} pro Monat bis zu deinem Ziel.",
  "pension.stat.points": "Entgeltpunkte (Prognose)",
  "pension.stat.statutory": "Gesetzliche Rente / Monat",
  "pension.stat.private": "Private Verträge / Monat",
  "pension.stat.total": "Gesamt / Monat",
  "pension.stat.earned": "Bisher erworben / Monat",
  "pension.stat.retirementYear": "Rentenbeginn",
  "pension.stat.accessFactor": "Zugangsfaktor",
  "pension.stat.level": "Rentenniveau",
  "pension.assumptions.title": "Annahmen",
  "pension.assumptions.hint": "Lass ein Feld leer, um den Standard zu nutzen: deine Regelaltersgrenze und den Durchschnitt deiner letzten fünf erfassten Jahre.",
  ...
  "pension.points.title": "Entgeltpunkte",
  "pension.statements.title": "Deine Renteninformationen",
  "pension.statements.hint":
    "Auf jeder Renteninformation steht nur dein GESAMTSTAND an Entgeltpunkten, nie ein Wert pro Jahr. Trag pro Brief eine Zeile ein. Ab dem zweiten Brief misst FinTrack aus der Differenz, was ein Jahr bringt.",
  "pension.statements.year": "Jahr der Renteninformation",
  "pension.statements.total": "Entgeltpunkte gesamt",
  "pension.statements.note": "Notiz",
  "pension.statements.add": "Renteninformation hinzufügen",
  "pension.statements.empty": "Noch keine Renteninformationen.",
  "pension.statements.invalid": "Trag ein Jahr und einen Gesamtstand ein.",
  "pension.statements.rate":
  ...
  "pension.points.add": "Jahr hinzufügen",
  "pension.points.empty": "Noch keine Jahre erfasst.",
  "pension.points.invalid": "Gib ein Jahr und eine Punktzahl ein.",
  "pension.points.deleteTitle": "Jahr löschen?",
  "pension.points.deleteMessage": "Die Punkte für {year} werden entfernt.",
  "pension.contracts.title": "Rentenversicherungen",
  "pension.contracts.hint": "Private, Riester-, Rürup- oder Betriebsrenten. Die erwartete monatliche Rente fließt in die Hochrechnung ein.",
  "pension.contracts.name": "Name",
  ...
  "pension.contracts.note": "Notiz",
  "pension.contracts.add": "Vertrag hinzufügen",
  "pension.contracts.edit": "Vertrag bearbeiten",
  "pension.contracts.empty": "Noch keine Verträge erfasst.",
  "pension.contracts.deleteTitle": "Vertrag löschen?",
  "pension.contracts.deleteMessage": "„{name}“ wird entfernt.",
  "pension.kind.private": "Private Rentenversicherung",
  "pension.kind.riester": "Riester-Rente",
  "pension.kind.ruerup": "Rürup-Rente (Basisrente)",
  "pension.kind.occupational": "Betriebsrente",
  "pension.kind.statutory_other": "Anderes gesetzliches Versorgungswerk",
  "pension.kind.other": "Sonstiges",
  "tour.pension.summary.title": "Deine Rente",
  "tour.pension.summary.body": "Was deine Entgeltpunkte und Verträge zusammen pro Monat ergeben, in heutigem Geld.",
  ...
  "debt.totals.repaidOf": "{repaid} von {original} getilgt ({pct}%)",
  "debt.list.interest": "Zinsen",
  ...
  "debt.list.editDetails": "Zins & Rate",
  ...
  "debt.details.intro": "Sollzins, nicht Effektivzins: der Plan rechnet pro Monat ein Zwölftel.",
  ...
  "debt.repayments.intro": "Sondertilgungen zum Simulieren. Wird nicht gespeichert.",
  "debt.repayments.accountLabel": "Verbindlichkeit",
  "debt.repayments.dateLabel": "Datum",
  "debt.repayments.amountLabel": "Betrag ({currency})",
  "debt.repayments.add": "Sondertilgung hinzufügen",
  "debt.repayments.remove": "Sondertilgung entfernen",
  "debt.repayments.empty": "Noch keine Sondertilgungen geplant.",
  "debt.details.error": "Konnte nicht gespeichert werden. Bitte versuch es erneut.",
  "debt.plan.title": "Tilgungsplan",
  "debt.plan.intro": "Jede Schuld mit ihrer Mindestrate, plus Extra auf jeweils eine.",
  "debt.plan.strategyLabel": "Strategie",
  "debt.plan.strategy.avalanche": "Avalanche (höchster Zinssatz zuerst)",
  "debt.plan.strategy.snowball": "Schneeball (kleinster Saldo zuerst)",
  "debt.plan.extraLabel": "Zusätzliche monatliche Zahlung ({currency})",
  ...
  "debt.chart.horizon.all": "Gesamt",
  "debt.chart.horizon.5y": "5 Jahre",
  "debt.chart.horizon.10y": "10 Jahre",
  ...
  "analysis.blurb.xray":
    "Dein tatsächliches Engagement in Einzelaktien, durch deine Fonds hindurch.",
  "analysis.blurb.returns":
  ...
  "household.subtitle": "Teile deine Konten mit Partner:in oder Familie.",
  "household.registeredOnly": "Melde dich an, um einen Haushalt zu erstellen oder beizutreten.",
  "household.actionError": "Konnte nicht gespeichert werden. Bitte versuche es erneut.",
  "household.createTitle": "Haushalt erstellen",
  "household.createSubtitle": "Erstelle einen Haushalt, um deine Konten mit einer eingeladenen Person zu teilen.",
  "household.namePlaceholder": "z. B. Unser Haushalt",
  "household.create": "Erstellen",
  ...
  "household.leaveConfirm": "Diesen Haushalt verlassen? Du verlierst den Zugriff auf geteilte Konten.",
  "household.inviteTitle": "Mitglied einladen",
  "household.emailPlaceholder": "E-Mail-Adresse",
  "household.invite": "Einladen",
  "household.revoke": "Widerrufen",
  "household.invitesReceived": "Einladungen",
  ...
  "rebalance.deviation": "Ist gegen Ziel",
  ...
  "sim.medianWealth": "Projiziertes Endvermögen im Median",
  ...
  "sim.runsLabel": "Läufe",
  "sim.contributed": "Eingezahltes Kapital",
  "sim.growth": "Wertzuwachs im Median",
  ...
  "admin.usage.new": "Neu (30 T.)",
  "admin.usage.errors": "Fehler (24 Std.)",
  ...
  "admin.usage.opsTitle": "Betrieb (30 Tage)",
  "admin.usage.shares": "Geteilte Portfolios",
  "admin.usage.imports": "Importierte CSV-Zeilen",
  "admin.usage.feature.assets": "Positionen",
  "admin.usage.feature.transactions": "Transaktionen",
  "admin.usage.feature.watchlist": "Watchlist",
  "admin.usage.feature.savingsPlans": "Sparpläne",
  "admin.usage.feature.tags": "Tags",
  "admin.usage.feature.accounts": "Konten & Verbindlichkeiten",
  "admin.usage.feature.accountBalances": "Saldostände",
  "admin.usage.feature.spending": "Ein- & Ausgaben",
  "admin.usage.feature.spendingCategories": "Ausgabenkategorien",
  "admin.usage.feature.recurring": "Wiederkehrende Zahlungen",
  "admin.usage.feature.plannedCashflow": "Geplanter Cashflow",
  "admin.usage.feature.goals": "Ziele",
  "admin.usage.feature.pensionPoints": "Entgeltpunkte",
  "admin.usage.feature.pensionContracts": "Rentenverträge",
  "admin.usage.feature.llm": "Assistent (eigener Schlüssel)",
  "admin.usage.feature.push": "Push-Benachrichtigungen",
  "admin.usage.feature.imports": "CSV-Import",
  "admin.usage.feature.sharing": "Geteilte Portfolios",
  "admin.usage.feature.proGrants": "Pro-Freischaltungen",
  "admin.nav.flags": "Flags",
  ...
  "admin.billing.keysTitle": "Stripe-Schlüssel",
  "admin.billing.keysSubtitle":
    "Ein gespeicherter Schlüssel hat Vorrang vor den Umgebungsvariablen STRIPE_SECRET_KEY / STRIPE_WEBHOOK_SECRET. Lass ein Feld leer, um den aktuellen Wert zu behalten.",
  "admin.billing.secretKeyLabel": "Geheimer Schlüssel",
  "admin.billing.secretKeyPlaceholder": "sk_live_...",
  "admin.billing.webhookSecretLabel": "Webhook-Geheimnis",
  "admin.billing.webhookSecretPlaceholder": "whsec_...",
  "admin.billing.statusSet": "Konfiguriert",
  "admin.billing.statusNotSet": "Nicht konfiguriert",
  "admin.billing.save": "Speichern",
  ...
  "admin.billing.grantSearchNoResults": "Keine Nutzer mit dieser E-Mail gefunden.",
  "admin.billing.grantChosen": "Ausgewählt: {email}",
  "admin.billing.grantEndDateLabel": "Enddatum (optional)",
  "admin.billing.grantNoteLabel": "Notiz (optional)",
  "admin.billing.grantNotePlaceholder": "z. B. danke für den Bug-Report",
  "admin.billing.grantButton": "Pro freischalten",
  "admin.billing.grantsColEmail": "E-Mail",
  "admin.billing.grantsColEndDate": "Enddatum",
  "admin.billing.grantsColNote": "Notiz",
  "admin.billing.grantsColCreated": "Erstellt",
  "admin.billing.grantsUnlimited": "Unbegrenzt",
  "admin.billing.grantsEmpty": "Noch keine Freischaltungen.",
  "admin.billing.revoke": "Entziehen",
  "admin.billing.revokeConfirmTitle": "Diese Freischaltung entziehen?",
  "admin.billing.revokeConfirmMsg": 'Pro-Zugang für "{email}" entziehen?',
  ...
  "admin.errors.levelAll": "Alle Stufen",
  "admin.errors.levelDebug": "Debug",
  "admin.errors.levelInfo": "Info",
  "admin.errors.levelWarn": "Warnung",
  "admin.errors.levelError": "Fehler",
  "admin.errors.levelFatal": "Kritisch",
  ...
  "admin.errors.kindFetch": "Anfrage",
  "admin.errors.kindFetchHelp": "Eine Anfrage kam mit Fehlerstatus zurück oder ging gar nicht durch",
  "admin.errors.kindConsole": "Konsole",
  "admin.errors.kindConsoleHelp": "Etwas, das als Fehler oder Warnung in der Browserkonsole gelandet ist",
  "admin.errors.kindServer": "Server",
  "admin.errors.kindServerHelp": "Eine API-Route oder Seite ist auf dem Server fehlgeschlagen",
  "admin.errors.count": "{count} von {total} geladenen Zeilen",
  "admin.errors.colLevel": "Stufe",
  ...
  "settings.billing.granted": "Premium geschenkt",
  "settings.billing.grantedUntil": "Premium geschenkt bis {date}",
  ...
  "pricing.pro.feature2": "Jährlicher Steuerreport",
  "pricing.pro.feature3": "Dividenden-Dashboard mit Prognose",
  "pricing.pro.feature4": "Monte-Carlo-Simulation",
  "pricing.pro.feature5": "ETF-X-Ray-Durchschau",
  "pricing.pro.feature6": "Rebalancing",
  "pricing.pro.perMonth": "{price} / Monat",
  "pricing.pro.perYear": "{price} / Jahr",
  "pricing.pro.pricesPending": "Preise folgen in Kürze",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "nav.accounts": "Cuentas y movimientos",
  ...
  "nav.account": "Cuenta",
  "notif.pending": "{count} pendientes",
  ...
  "sp.debitAccountNone": "Sin cuenta",
  "sp.debitAccountFormHint":
    "Cada ejecución contabiliza además el importe como salida en esta cuenta.",
  "sp.debitAccountHint":
    "Las ejecuciones con cuenta contabilizan allí el cargo correspondiente. Cuenta como traspaso, no como gasto.",
  ...
  "tour.areas.body":
    "El mes de un vistazo: a la izquierda lo que entra y sale, a la derecha el avance de tu reserva, objetivos y deudas. La pantalla de inicio cubre toda tu situación financiera, no solo la cartera.",
  ...
  // Round-24 page tours: one per primary surface (lib/onboarding/tour-steps.ts).
  "tour.accounts.totals.title": "Saldos de un vistazo",
  "tour.accounts.totals.body":
    "Tus saldos, tus saldos de crédito, la variación en el periodo y cuántas cuentas. El gráfico de abajo muestra su evolución. Todo eso entra en tu patrimonio neto.",
  ...
  "import.hint": "Exporta tu historial de transacciones como archivo CSV desde tu bróker o exchange.",
  "import.detected": "Detectado",
  "import.unknownFormat": "Formato de CSV no reconocido.",
  "import.formatDisabled": "La importación de Portfolio Performance está desactivada por ahora.",
  ...
  "cat.group.debt": "Préstamos",
  "cat.debt.repayment": "Amortización del préstamo",
  "cat.debt.interest": "Intereses del préstamo",
  ...
  "overview.status.liquid": "Liquidez disponible",
  "overview.status.liquidTip": "Saldo en tus cuentas corrientes y de ahorro.",
  "overview.status.invested": "Invertido",
  "overview.status.investedTip": "Valor de mercado actual de tus posiciones.",
  "overview.status.liabilitiesTip": "Todo lo que debes en tus cuentas de pasivos.",
  "overview.chart.assets": "Activos",
  "overview.plan.title": "Progreso del plan",
  "overview.plan.reserve": "Fondo de emergencia",
  "overview.plan.debtPaid": "Deuda pagada",
  "overview.plan.allGoals": "Todos los objetivos",
  "overview.insights.title": "Notas importantes",
  "overview.insight.negativeSavings": "Gastas más de lo que ingresas ({rate} por encima).",
  "overview.insight.reserveLow": "Tu fondo de emergencia cubre {months} de {target} meses.",
  "overview.insight.highDebt": "Tu deuda es {multiple} veces tu ingreso anual.",
  "overview.insight.goalsReached": "Has alcanzado {n} objetivo(s). Bien hecho.",
  "chart.netWorthBreakdown.ariaLabel":
    "Desglose del patrimonio neto, {timeframe}: activos frente a pasivos de {start} a {end}, neto {net}.",
  "tip.depotValue": "Valor de mercado actual de tus posiciones. Las cuentas y los pasivos no se incluyen aquí.",
  "tip.change": "Variación neta en el periodo\n% = rentabilidad ponderada en el tiempo (ajustada por aportaciones)",
  "tip.changeBreakdown": "Variación neta en el periodo\n{parts}\n% = rentabilidad ponderada en el tiempo",
  ...
  "sankeyShare.full": "Compartir con importes",
  "sankeyShare.fullDesc": "Incluye ingresos y gastos absolutos.",
  "sankeyShare.incognito": "Compartir en incógnito",
  "sankeyShare.incognitoDesc": "Solo flujos relativos, sin importes.",
  "shared.viewing": "Estás viendo una vista compartida",
  "degraded.banner": "Algunas áreas no se pudieron cargar ({areas}). El resto funciona con normalidad.",
  ...
  "asset.periodReturn": "rentabilidad ({tf})",
  ...
  "cashInterest.freq.QUARTERLY": "Trimestral",
  "cashInterest.freq.ANNUAL": "Anual",
  "cashInterest.postDayLabel": "Se abona el",
  "cashInterest.postDay.first": "Primer día del mes",
  "cashInterest.postDay.last": "Último día del mes",
  "cashInterest.save": "Guardar",
  "cashInterest.saved": "Guardado",
  "cashInterest.disable": "Pon la tasa a 0 para desactivar los intereses.",
  "cashInterest.next": "Próximo abono el {date}.",
  "cashInterest.due": "{count} abono(s) de intereses pendientes, {total} en total.",
  ...
  "accounts.title": "Cuentas y movimientos",
  "accounts.subtitle": "Efectivo, ahorros, deudas y cada movimiento sobre ellos.",
  ...
  "accounts.tab.accounts": "Cuentas",
  "accounts.tab.bookings": "Movimientos",
  "accounts.tab.recurring": "Recurrentes",
  "accounts.group.payments": "Pagos",
  "accounts.group.reserves": "Reservas",
  "accounts.group.other": "Otros",
  "accounts.group.credit": "Créditos",
  "accounts.summary.balance": "Saldo",
  "accounts.summary.creditBalances": "Saldos de crédito",
  "accounts.summary.count": "Cuentas",
  "accounts.chart.title": "Evolución",
  "accounts.hero.allScope": "Neto de todas las cuentas",
  "accounts.hero.someScope": "Neto de las cuentas seleccionadas",
  "accounts.hero.oneScope": "Saldo",
  "accounts.hero.pick": "Qué cuentas se muestran",
  "accounts.hero.change": "Variación ({timeframe})",
  "accounts.hero.count": "Cuentas",
  "accounts.hero.noChart": "Todavía no hay suficiente historial para una curva.",
  "accounts.hero.chartAria": "Saldo de {scope} del {start} al {end}, variación {change}.",
  ...
  "accounts.form.namePlaceholder": "p. ej. Cuenta corriente",
  "accounts.form.kindLabel": "Tipo",
  "accounts.form.currencyLabel": "Moneda",
  "accounts.form.openingLabel": "Saldo inicial ({currency})",
  "accounts.form.openedLabel": "A fecha de",
  ...
  "accounts.kind.checking": "Cuenta corriente",
  "accounts.kind.savings": "Cuenta de ahorro",
  "accounts.kind.credit": "Tarjeta de crédito",
  "accounts.kind.loan": "Préstamo",
  ...
  "spending.subtitle": "Movimientos de gastos e ingresos en tus cuentas.",
  "spending.totals.income": "Ingresos",
  "spending.totals.expense": "Gastos",
  "spending.totals.net": "Neto",
  "spending.form.title": "Añadir un movimiento",
  "spending.form.noAccounts": "Necesitas una cuenta antes de poder registrar gastos. Añade una en la página de Cuentas primero.",
  "spending.form.accountLabel": "Cuenta",
  "spending.form.typeLabel": "Tipo",
  "spending.form.type.expense": "Gasto",
  "spending.form.type.income": "Ingreso",
  "spending.form.amountLabel": "Importe ({currency})",
  "spending.form.payeeLabel": "Beneficiario",
  "spending.form.payeePlaceholder": "p. ej. Rewe",
  "spending.form.payerLabel": "Pagador",
  "spending.form.payerPlaceholder": "p. ej. empleador",
  "spending.form.categoryLabel": "Categoría",
  "spending.form.categoryNone": "Sin categoría",
  "spending.form.dateLabel": "Fecha",
  "spending.form.timeLabel": "Hora",
  "spending.form.noteLabel": "Nota",
  "spending.form.notePlaceholder": "Opcional",
  ...
  "spending.list.payer": "Pagador",
  "spending.list.category": "Categoría",
  "spending.list.amount": "Importe",
  "spending.list.delete": "Eliminar",
  "spending.list.edit": "Editar",
  "spending.edit.title": "Editar movimiento",
  "spending.edit.save": "Guardar",
  "spending.edit.originNote": "Este movimiento procede de un pago recurrente o planificado. Puedes cambiar sus cifras, pero no su origen.",
  "spending.edit.transferLabel": "Traspaso a",
  "spending.edit.transferNone": "No es un traspaso",
  "spending.edit.transferHintOn": "Cuenta como traspaso: mueve la otra cuenta y queda fuera de ingresos y gastos.",
  "spending.edit.transferHintOff": "Cuenta como un gasto o ingreso normal.",
  "spending.list.uncategorized": "Sin categoría",
  "spending.delete.title": "Eliminar movimiento",
  ...
  "spending.categories.newCategory": "+ Nueva categoría",
  "spending.categories.newGroup": "+ Nuevo grupo",
  "spending.categories.add": "Añadir",
  "spending.categories.delete": "Eliminar",
  ...
  "spending.budgets.noCategoriesTitle": "Aún no hay categorías",
  ...
  "spending.budgets.emptyTitle": "Todavía no hay presupuestos",
  "spending.budgets.emptyCta": "Crea tu primer presupuesto",
  ...
  "spending.budgets.error": "No se pudo guardar el presupuesto. Inténtalo de nuevo.",
  "spending.budgets.overBudget": "{amount} por encima del presupuesto",
  "spending.budgets.delete": "Eliminar presupuesto",
  "spending.budgets.deleteConfirm": "¿Eliminar el presupuesto de \"{name}\"?",
  ...
  "spending.planned.typeLabel": "Tipo",
  "spending.planned.type.income": "Ingreso",
  "spending.planned.type.expense": "Gasto",
  "spending.planned.amountLabel": "Importe ({currency})",
  "spending.planned.categoryLabel": "Categoría",
  "spending.planned.categoryNone": "Sin categoría",
  "spending.planned.intervalLabel": "Intervalo",
  "spending.planned.interval.ONCE": "Una vez",
  "spending.planned.interval.WEEKLY": "Semanal",
  "spending.planned.interval.MONTHLY": "Mensual",
  "spending.planned.interval.QUARTERLY": "Trimestral",
  "spending.planned.interval.ANNUAL": "Anual",
  "spending.planned.startLabel": "Primera fecha",
  "spending.planned.endLabel": "Última fecha (opcional)",
  ...
  "spending.planned.save": "Guardar",
  "spending.planned.cancel": "Cancelar",
  "spending.planned.edit": "Editar",
  "spending.planned.editTitle": "Editar previsión",
  "spending.planned.delete": "Eliminar",
  "spending.planned.deleteTitle": "Eliminar previsión",
  "spending.planned.deleteConfirm":
    "¿Eliminar \"{name}\"? Los movimientos ya registrados se quedan como están.",
  "spending.planned.error": "No se ha podido guardar la previsión. Inténtalo de nuevo.",
  "spending.planned.col.name": "Descripción",
  "spending.planned.col.account": "Cuenta",
  "spending.planned.col.category": "Categoría",
  "spending.planned.col.interval": "Intervalo",
  "spending.planned.col.next": "Próxima fecha",
  "spending.planned.col.amount": "Importe",
  "spending.planned.col.monthly": "Al mes",
  "spending.planned.finished": "Finalizado",
  "spending.planned.due.button": "Registrar {n} pago(s) vencido(s)",
  "spending.planned.due.title": "Movimientos pendientes",
  "spending.planned.due.intro":
    "Hay {n} pago(s) previsto(s) vencido(s). Revisa los importes, casi nunca salen exactamente como estaba previsto.",
  "spending.planned.due.date": "Fecha",
  "spending.planned.due.name": "Descripción",
  "spending.planned.due.account": "Cuenta",
  "spending.planned.due.amount": "Importe",
  "spending.planned.due.book": "Registrar ahora",
  ...
  "spending.forecast.plannedIncome": "Ingresos previstos",
  "spending.forecast.plannedExpense": "Gastos previstos",
  "spending.forecast.cumulative": "Acumulado",
  "spending.forecast.monthlyIncome": "Ingresos previstos al mes",
  "spending.forecast.monthlyExpense": "Gastos previstos al mes",
  ...
  "contracts.form.namePlaceholder": "p.ej. Netflix",
  "contracts.form.amountLabel": "Importe ({currency})",
  "contracts.form.intervalLabel": "Facturación",
  "contracts.form.categoryLabel": "Categoría",
  "contracts.form.renewalLabel": "Fecha de renovación",
  "contracts.form.noticeLabel": "Plazo de cancelación (días)",
  "contracts.form.add": "Añadir",
  "contracts.form.error": "No se pudo guardar el pago recurrente. Inténtalo de nuevo.",
  "contracts.list.delete": "Eliminar",
  "contracts.list.noCategory": "Sin categoría",
  "contracts.delete.title": "Eliminar pago recurrente",
  "contracts.delete.message": "¿Eliminar \"{name}\"? Esta acción no se puede deshacer.",
  "contracts.interval.MONTHLY": "Mensual",
  "contracts.interval.QUARTERLY": "Trimestral",
  "contracts.interval.ANNUAL": "Anual",
  "cashflow.title": "Flujo de caja",
  "cashflow.subtitle": "Adónde va el dinero y si cuadra.",
  "cashflow.tab.overview": "Resumen",
  "cashflow.tab.budgets": "Presupuestos",
  "cashflow.tab.forecast": "Previsión",
  "cashflow.flow.title": "Flujo de dinero",
  "cashflow.view.bars": "Barras",
  "cashflow.view.flow": "Flujo",
  ...
  "recurring.col.interval": "Ritmo",
  "recurring.col.target": "Destino",
  "recurring.monthEnd": "Siempre el último día del mes",
  "recurring.interestName": "Intereses · {name}",
  "recurring.interestAuto": "Se registra automáticamente",
  "recurring.due.autoBooked": "{n} registro(s) de intereses hechos automáticamente",
  "recurring.target.consumed": "Consumido",
  "recurring.target.credited": "Abono",
  "recurring.col.next": "Próxima",
  "recurring.due.banner": "{n} registro(s) pendiente(s)",
  ...
  "recurring.interval.WEEKLY": "Semanal",
  "recurring.interval.MONTHLY": "Mensual",
  "recurring.interval.QUARTERLY": "Trimestral",
  "recurring.interval.ANNUAL": "Anual",
  "portfolio.title": "Cartera",
  "portfolio.subtitle": "Tus posiciones, planes de ahorro y lista de seguimiento.",
  "portfolio.tab.positions": "Posiciones",
  "portfolio.tab.savings": "Planes de ahorro",
  "portfolio.tab.watchlist": "Lista de seguimiento",
  "portfolio.tab.history": "Historial",
  "dashboard.month.title": "Este mes",
  "dashboard.month.in": "Ingresos",
  "dashboard.month.out": "Gastos",
  "dashboard.month.open": "Pendiente",
  "dashboard.month.hint": "",
  "spending.form.recurring": "Recurrente",
  "spending.form.recurringHint": "Se repite automáticamente desde la fecha de inicio",
  "table.page.range": "{from}\u2013{to} de {total}",
  "table.page.of": "P\u00e1gina {page} de {pages}",
  "table.page.prev": "Atr\u00e1s",
  "table.page.next": "Siguiente",
  "spending.form.addRecurring": "Crear entrada recurrente",
  "recurring.detail.subtitle": "Todo lo que ha registrado esta entrada.",
  "recurring.detail.bookings": "Movimientos",
  "recurring.detail.noBookings": "Todavía no hay movimientos.",
  "recurring.detail.bookedTotal": "Registrado hasta ahora",
  ...
  "contracts.form.kindContract": "Pago",
  ...
  "spending.list.makeContractTitle": "¿Añadir este movimiento como entrada recurrente?",
  "spending.list.makeContractMsg": "Crea una entrada recurrente mensual para {payee} a partir de este movimiento. Puedes cambiar el ritmo y lo demás en su propia página.",
  ...
  "contracts.insuranceType.household": "Hogar",
  "contracts.insuranceType.legal": "Protección jurídica",
  "contracts.insuranceType.disability": "Incapacidad / protección de ingresos",
  "contracts.insuranceType.life": "Vida",
  ...
  "goals.form.emptyHint": "Fija un importe objetivo y sigue tu progreso hacia él.",
  ...
  "goals.form.groupDepots": "Carteras",
  "goals.form.groupPositions": "Posiciones",
  "goals.form.groupAccounts": "Cuentas",
  ...
  "goals.list.current": "Ahorrado",
  "goals.list.status": "Estado",
  "goals.status.reached": "Alcanzada",
  "goals.status.onTrack": "En camino",
  "goals.status.overdue": "Atrasada",
  "goals.summary.count": "Metas",
  "goals.summary.target": "Objetivo total",
  "goals.summary.saved": "Ahorrado",
  "goals.summary.progress": "Progreso total",
  ...
  "pension.stat.statutory": "Pensión pública / mes",
  "pension.stat.private": "Planes privados / mes",
  "pension.stat.total": "Total / mes",
  "pension.stat.earned": "Acumulado hasta hoy / mes",
  "pension.stat.retirementYear": "Año de jubilación",
  "pension.stat.accessFactor": "Factor de acceso",
  "pension.stat.level": "Nivel de pensión",
  "pension.assumptions.title": "Supuestos",
  "pension.assumptions.hint": "Deja un campo vacío para usar el valor por defecto: tu edad ordinaria de jubilación y la media de tus últimos cinco años registrados.",
  ...
  "pension.statements.add": "Añadir informe",
  "pension.statements.empty": "Todavía no hay informes.",
  "pension.statements.invalid": "Introduce un año y un total.",
  "pension.statements.rate":
  ...
  "pension.points.add": "Añadir año",
  "pension.points.empty": "Todavía no hay años registrados.",
  "pension.points.invalid": "Introduce un año y un número de puntos.",
  ...
  "pension.contracts.note": "Nota",
  "pension.contracts.add": "Añadir plan",
  "pension.contracts.edit": "Editar plan",
  "pension.contracts.empty": "Todavía no hay planes registrados.",
  "pension.contracts.deleteTitle": "¿Eliminar el plan?",
  "pension.contracts.deleteMessage": "Se eliminará “{name}”.",
  "pension.kind.private": "Plan de pensiones privado",
  "pension.kind.riester": "Riester",
  "pension.kind.ruerup": "Rürup (Basisrente)",
  "pension.kind.occupational": "Plan de empresa",
  "pension.kind.statutory_other": "Otro régimen público",
  "pension.kind.other": "Otro",
  "tour.pension.summary.title": "Tu ingreso de jubilación",
  "tour.pension.summary.body": "Lo que suman al mes tus puntos de pensión y tus planes, en dinero de hoy.",
  ...
  "debt.totals.repaidOf": "{repaid} de {original} amortizado ({pct}%)",
  "debt.list.interest": "Intereses",
  ...
  "debt.details.intro": "Tipo nominal, no TAE: el plan aplica una doceava parte al mes.",
  ...
  "debt.repayments.intro": "Añade importes puntuales para simular. No se guarda.",
  "debt.repayments.accountLabel": "Pasivo",
  "debt.repayments.dateLabel": "Fecha",
  "debt.repayments.amountLabel": "Importe ({currency})",
  "debt.repayments.add": "Añadir amortización",
  "debt.repayments.remove": "Quitar amortización",
  "debt.repayments.empty": "Todavía no hay amortizaciones anticipadas planificadas.",
  "debt.details.error": "No se pudo guardar. Inténtalo de nuevo.",
  "debt.plan.title": "Plan de pago",
  "debt.plan.intro": "Cada deuda con su mínimo, más un extra sobre una cada vez.",
  "debt.plan.strategyLabel": "Estrategia",
  "debt.plan.strategy.avalanche": "Avalancha (tasa más alta primero)",
  "debt.plan.strategy.snowball": "Bola de nieve (saldo más pequeño primero)",
  "debt.plan.extraLabel": "Pago mensual extra ({currency})",
  ...
  "debt.chart.horizon.all": "Total",
  "debt.chart.horizon.5y": "5 años",
  "debt.chart.horizon.10y": "10 años",
  "addAsset.otherValue": "Valor actual ({currency})",

  // Analysis
  "analysis.tab.distributions": "Distribuciones",
  "analysis.tab.xray": "Rayos X",
  ...
  "analysis.blurb.xray":
    "Tu exposición real a acciones individuales, mirando a través de tus fondos.",
  "analysis.blurb.returns":
  ...
  "household.subtitle": "Comparte tus cuentas con tu pareja o familia.",
  ...
  "household.leaveConfirm": "¿Salir de este hogar? Perderás el acceso a las cuentas compartidas.",
  "household.inviteTitle": "Invitar a un miembro",
  "household.emailPlaceholder": "Correo electrónico",
  "household.invite": "Invitar",
  "household.revoke": "Revocar",
  "household.invitesReceived": "Invitaciones",
  ...
  "rebalance.deviation": "Actual frente a objetivo",
  ...
  "sim.medianWealth": "Patrimonio final proyectado (mediana)",
  ...
  "sim.contributed": "Capital aportado",
  "sim.growth": "Plusvalía (mediana)",
  ...
  "admin.usage.new": "Nuevos (30 d)",
  "admin.usage.errors": "Errores (24 h)",
  ...
  "admin.usage.opsTitle": "Operación (30 días)",
  "admin.usage.shares": "Carteras compartidas",
  "admin.usage.imports": "Filas CSV importadas",
  "admin.usage.feature.assets": "Posiciones",
  "admin.usage.feature.transactions": "Transacciones",
  "admin.usage.feature.watchlist": "Lista de seguimiento",
  "admin.usage.feature.savingsPlans": "Planes de ahorro",
  "admin.usage.feature.tags": "Etiquetas",
  "admin.usage.feature.accounts": "Cuentas y pasivos",
  "admin.usage.feature.accountBalances": "Saldos registrados",
  "admin.usage.feature.spending": "Ingresos y gastos",
  "admin.usage.feature.spendingCategories": "Categorías de gasto",
  "admin.usage.feature.recurring": "Pagos recurrentes",
  "admin.usage.feature.plannedCashflow": "Flujo de caja planificado",
  "admin.usage.feature.goals": "Objetivos",
  "admin.usage.feature.pensionPoints": "Puntos de pensión",
  "admin.usage.feature.pensionContracts": "Planes de pensiones",
  "admin.usage.feature.llm": "Asistente (clave propia)",
  "admin.usage.feature.push": "Notificaciones push",
  "admin.usage.feature.imports": "Importación CSV",
  "admin.usage.feature.sharing": "Carteras compartidas",
  "admin.usage.feature.proGrants": "Concesiones Pro",
  "admin.nav.flags": "Flags",
  ...
  "admin.billing.keysTitle": "Claves de Stripe",
  "admin.billing.keysSubtitle":
    "Una clave guardada tiene prioridad sobre las variables de entorno STRIPE_SECRET_KEY / STRIPE_WEBHOOK_SECRET. Deja un campo vacío para mantener su valor actual.",
  "admin.billing.secretKeyLabel": "Clave secreta",
  "admin.billing.secretKeyPlaceholder": "sk_live_...",
  "admin.billing.webhookSecretLabel": "Secreto del webhook",
  "admin.billing.webhookSecretPlaceholder": "whsec_...",
  "admin.billing.statusSet": "Configurada",
  "admin.billing.statusNotSet": "No configurada",
  "admin.billing.save": "Guardar",
  ...
  "admin.billing.grantSearchNoResults": "Ningún usuario coincide con ese email.",
  "admin.billing.grantChosen": "Elegido: {email}",
  "admin.billing.grantEndDateLabel": "Fecha de fin (opcional)",
  "admin.billing.grantNoteLabel": "Nota (opcional)",
  "admin.billing.grantNotePlaceholder": "p. ej. gracias por el reporte de error",
  "admin.billing.grantButton": "Conceder Pro",
  "admin.billing.grantsColEmail": "Email",
  "admin.billing.grantsColEndDate": "Fecha de fin",
  "admin.billing.grantsColNote": "Nota",
  "admin.billing.grantsColCreated": "Creado",
  "admin.billing.grantsUnlimited": "Ilimitado",
  "admin.billing.grantsEmpty": "Todavía no hay concesiones.",
  "admin.billing.revoke": "Revocar",
  "admin.billing.revokeConfirmTitle": "¿Revocar esta concesión?",
  "admin.billing.revokeConfirmMsg": '¿Revocar el acceso Pro concedido a "{email}"?',
  ...
  "admin.errors.levelAll": "Todos los niveles",
  "admin.errors.levelDebug": "Depuración",
  "admin.errors.levelInfo": "Info",
  "admin.errors.levelWarn": "Advertencia",
  "admin.errors.levelError": "Error",
  "admin.errors.levelFatal": "Crítico",
  ...
  "admin.errors.kindConsoleHelp": "Algo escrito en la consola del navegador como error o advertencia",
  "admin.errors.kindServer": "Servidor",
  "admin.errors.kindServerHelp": "Una ruta de API o una página ha fallado en el servidor",
  "admin.errors.count": "Mostrando {count} de {total} filas cargadas",
  "admin.errors.colLevel": "Nivel",
  ...
  "settings.billing.granted": "Premium regalado",
  "settings.billing.grantedUntil": "Premium regalado hasta el {date}",
  ...
  "pricing.pro.feature2": "Informe fiscal anual",
  "pricing.pro.feature3": "Panel de dividendos con previsión",
  "pricing.pro.feature4": "Simulación Monte Carlo",
  "pricing.pro.feature5": "Análisis x-ray de ETFs",
  "pricing.pro.feature6": "Rebalanceo",
  "pricing.pro.perMonth": "{price} / mes",
  "pricing.pro.perYear": "{price} / año",
  "pricing.pro.pricesPending": "Precios disponibles próximamente",
