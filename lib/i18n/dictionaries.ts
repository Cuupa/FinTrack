...
export const en = {
  ...
  "tip.changeBreakdown": "Change in net worth over the timeframe. Made up of: {parts}. The percentage is the time-weighted (contribution-adjusted) return.",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "tip.changeBreakdown": "Veränderung des Nettovermögens im Zeitraum. Setzt sich zusammen aus: {parts}. Der Prozentwert ist die zeitgewichtete (einzahlungsbereinigte) Rendite.",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "tip.changeBreakdown": "Variación del patrimonio neto en el periodo. Se compone de: {parts}. El porcentaje es la rentabilidad ponderada en el tiempo (ajustada por aportaciones).",
