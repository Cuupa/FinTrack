...
export const en = {
  ...
  "goals.title": "Goals",
  "goals.subtitle":
    "Saving up or paying a debt off, tracked by a linked account or by hand.",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "goals.title": "Ziele",
  "goals.subtitle":
    "Sparen oder Schulden abbezahlen, verfolgt über ein verknüpftes Konto oder manuell.",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "goals.title": "Metas",
  "goals.subtitle":
    "Ahorrar o amortizar una deuda, con seguimiento por una cuenta vinculada o manual.",
