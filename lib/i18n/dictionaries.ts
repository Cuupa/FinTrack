...
export const en = {
  ...
  "sp.newCash": "+ Cash position (e.g. VL)…",
  "sp.newAssetCash": "Lookup can't create cash positions. Add the cash position via \"Add position\" first, then pick it here.",
  "sp.cashPlanHint": "Books recurring deposits into this cash position, e.g. capital-forming benefits (VL).",
  "sp.amount": "Amount",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "sp.newCash": "+ Cash-Position (z. B. VL)…",
  ...
  "sp.cashPlanHint": "Bucht regelmäßige Einzahlungen auf diese Cash-Position, z. B. vermögenswirksame Leistungen (VL).",
  "sp.amount": "Betrag",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "sp.newCash": "+ Posición de efectivo (p. ej. VL)…",
  ...
  "sp.cashPlanHint": "Registra ingresos periódicos en esta posición de efectivo, por ejemplo aportaciones del empleador (VL).",
  "sp.amount": "Importe",
  ...
  "sp.reviewHint":
    "Cada fila se convierte en una compra normal al precio mostrado (el cierre real de ese día cuando está disponible). No se registra nada hasta que lo confirmes.",
  "sp.confirm": "Registrar {count} compra(s)",
