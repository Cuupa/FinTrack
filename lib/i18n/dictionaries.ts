...
export const en = {
  ...
  "settings.ai.removeKeyMsg": "Your stored API key is removed from this browser.",
  "settings.ai.removeKeyConfirm": "Remove",
  "settings.ai.privacyNote":
    "Your key stays only in this browser. When you use the chat, your portfolio data is sent to the provider you choose.",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "settings.ai.removeKeyMsg": "Dein gespeicherter API-Schlüssel wird aus diesem Browser entfernt.",
  "settings.ai.removeKeyConfirm": "Entfernen",
  "settings.ai.privacyNote":
    "Dein Schlüssel bleibt nur in diesem Browser gespeichert. Wenn du den Chat nutzt, werden deine Portfoliodaten an den gewählten Anbieter gesendet.",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "settings.ai.removeKeyMsg": "Tu clave de API guardada se elimina de este navegador.",
  "settings.ai.removeKeyConfirm": "Eliminar",
  "settings.ai.privacyNote":
    "Tu clave se guarda solo en este navegador. Cuando usas el chat, tus datos de cartera se envían al proveedor que elijas.",
