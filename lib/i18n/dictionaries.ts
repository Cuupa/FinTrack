...
export const en = {
  ...
  "spending.list.makeContractMsg": "Creates a monthly recurring payment for {payee} from this booking. You can change the rhythm and everything else on its own page.",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "spending.list.makeContractMsg": "Legt aus dieser Buchung eine monatliche wiederkehrende Zahlung für {payee} an. Rhythmus und alles Weitere kannst du auf ihrer eigenen Seite ändern.",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "spending.list.makeContractMsg": "Crea un pago recurrente mensual para {payee} a partir de este movimiento. Puedes cambiar el ritmo y lo demás en su propia página.",
