...
export const en = {
  ...
  "div.calendar": "Upcoming dividends",
  "div.calendarTip": "Confirmed ex- and pay-dates from the payer's announced calendar, for the dividend payers you hold. Only dates the payer has published show up here.",
  "div.calendarEmpty": "No confirmed upcoming dates yet. They appear once a payer you hold publishes its next ex- or pay-date.",
  "div.exDate": "Ex-date",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "div.calendar": "Anstehende Dividenden",
  "div.calendarTip": "Bestätigte Ex- und Zahltage aus dem angekündigten Ausschüttungskalender, für deine ausschüttenden Positionen. Hier erscheinen nur Termine, die bereits veröffentlicht wurden.",
  "div.calendarEmpty": "Noch keine bestätigten Termine. Sie erscheinen, sobald für eine deiner ausschüttenden Positionen der nächste Ex- oder Zahltag veröffentlicht wird.",
  "div.exDate": "Ex-Tag",
  "div.payDate": "Zahltag",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "div.calendar": "Próximos dividendos",
  "div.calendarTip": "Fechas ex- y de pago confirmadas del calendario anunciado por el pagador, para tus posiciones que reparten dividendos. Aquí solo aparecen las fechas que el pagador ha publicado.",
  "div.calendarEmpty": "Aún no hay fechas confirmadas. Aparecerán cuando un pagador que tengas publique su próxima fecha ex- o de pago.",
  "div.exDate": "Fecha ex",
