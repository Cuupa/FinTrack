...
export const en = {
  ...
  "recurring.empty": "Nothing recurring yet. Tick \u201crecurring\u201d when you add an entry above.",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "recurring.empty": "Noch nichts Wiederkehrendes. Setz oben beim Erfassen den Haken \u201ewiederkehrend\u201c.",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "recurring.empty": "Todavía nada recurrente. Marca \u201crecurrente\u201d al añadir una entrada arriba.",
