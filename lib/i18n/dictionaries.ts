...
export const en = {
  ...
  "recurring.due.cancelAmount": "Cancel amount edit",
  "recurring.due.confirmAmount": "Apply",
...
export const de: Partial<Record<MessageKey, string>> = {
  ...
  "recurring.due.cancelAmount": "Betragsänderung abbrechen",
  "recurring.due.confirmAmount": "Übernehmen",
...
export const es: Partial<Record<MessageKey, string>> = {
  ...
  "recurring.due.cancelAmount": "Cancelar edición del importe",
  "recurring.due.confirmAmount": "Aplicar",
  "recurring.due.occurrence": "Original: {date}",
